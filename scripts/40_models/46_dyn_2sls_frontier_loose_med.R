# scripts/40_models/46_dyn_2sls_frontier_loose_med.R

# ---- paths ----
proj_root <- rprojroot::find_rstudio_root_file()

model_dir <- file.path(proj_root, "outputs", "models")
model_rds <- file.path(model_dir, "model_dyn_2sls_frontier_loose_med.rds")
dir.create(model_dir, recursive = TRUE, showWarnings = FALSE)


# ---- estimate dynamic 2SLS (frontier loose_med) ----
dyn_iv <- feols(
